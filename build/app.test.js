...
describe("appTest", () => {
    describe("/", () => {
        it("sends a welcome message", () => __awaiter(this, void 0, void 0, function* () {
            const response = yield request(appTest).get("/");
            expect(response.text).toEqual("Welcome 99 Pokemon");
        }));
    });
    describe("/bugs", () => {
        it("sends an h1 message", () => __awaiter(this, void 0, void 0, function* () {
    ...
    describe("/bugs/:numberOfBugs", () => {
        it("sends an error link when too many bugs are requested", () => __awaiter(this, void 0, void 0, function* () {
            const response = yield request(appTest).get(`/bugs/200`);
            expect(response.text).toContain("Too many bugs!! Start over!");
        }));
        it("sends a 'next' link when a small enough number of bugs is requested", () => __awaiter(this, void 0, void 0, function* () {
